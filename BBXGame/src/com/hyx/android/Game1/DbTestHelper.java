...
public class DbTestHelper extends SQLiteOpenHelper {
	private final static String DATABASE_NAME="bbx_db2"; 
	private final static int DATABASE_VERSION=5;
	private final static String TABLE_NAME="bbx_testrecord"; 
	...
	public final static String FIELD_DATE="record_DATE";
	...
	public void onCreate(SQLiteDatabase db) {
		...
		String sql="Create table "+TABLE_NAME+"("+FIELD_ID+" integer primary key autoincrement," +FIELD_CLASSNAME+" text ," +FIELD_TIME+" int," +FIELD_USER+" text," +FIELD_DATE+" text);"; 
		db.execSQL(sql); 
	}
	...
	public long insert(String classname,int time,String user,String date) 
	{ 
